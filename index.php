...
<? include('include/footer.php'); ?>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>made by kang dong a 2021</small></div>
        </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-5">
                                        네이버 뉴스 sns 크롤링을 통한 비정형 빅데이터 수집 및 처리 <br>
                                        데이터 마이닝을 통한 유사도 분석 및 키워드 추출 
                                    </p>
                                    <button class="btn btn-primary" data-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                                        Close Window
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="data_1.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-5">
                                      voting bagging 등을 활용한 XGboost LGM 등의 기법을 통해 <br>
                                      금융투자자들을 위한 추천 시스템 알고리즘 구현 <br>
